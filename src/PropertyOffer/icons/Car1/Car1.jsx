...
export const Car1 = ({ className }) => {
  return (
    <svg
      className={`car-1 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      ...
      <path
        className="path"
        d="M21 11.25L18.1969 4.95C18.1387 4.81672 18.043 4.70322 17.9215 4.62333C17.8 4.54343 17.6579 4.50058 17.5125 4.5H6.4875C6.34208 4.50058 6.19997 4.54343 6.07846 4.62333C5.95695 4.70322 5.86129 4.81672 5.80312 4.95L3 11.25V17.25H21V11.25Z"
        stroke="#4A60A1"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.60606"
